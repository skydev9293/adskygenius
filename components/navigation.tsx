        ...
        <div className="flex justify-between items-center h-16">
          ...
          <Link href="/" className="flex items-center space-x-2">
            <div className="w-8 h-8 rounded-lg flex items-center justify-center">
              <img src="/company_logo.png" alt="AdSky Genius Logo" className="w-10 h-10 object-contain" />
            </div>
            <span className="font-serif font-bold text-xl text-foreground">AdSky Genius</span>
          </Link>
